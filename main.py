...
#auto = SMCA((W,H))
auto = SMCA((W,H), True) # Disables clump counting #! Right now there is a bug in the clump counting. It stops working when all partilces in one direction have disappeared
updating = True
recording = False
launch_video = False
