...
#     #! Randomize the execution order by picking first the functions, and then shuffling them, It does not work yet. 
#     # execution_order = [
#     #     'propagation_prot_neut_step',
#     #     'propagation_photon_step', [1,2]
#     #     'sticking_step', [0,1]
#     #     #'scattering_step',[0,1]
#     #     #'protonaction_step',
#     #     #'neutronaction_step',
...
#         "particle_counting_steps": 0, # After each n steps the code gives you a statistics of number of particles

#         "Probability_of_sticking": random.uniform(0,1.1), # Clip it to one
...
#         "Sticking_w1_input": random.choice([1,2,3]),
#         "Sticking_w2_input": 1, # Put appropriate choices
#         "Sticking_w3_input": 0,
#         "Sticking_w4_input": 0,
